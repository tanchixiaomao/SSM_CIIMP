...
<body class="login">
	...
	<div class="content">
		...
		<form class="form-vertical login-form" action="/user_login" id="login_form_2">
			...
			<div class="alert alert-error " id="alert_error_2">

				<button class="close" data-dismiss="alert"></button>

				<span id="login_alert_2"></span>
				...
				<div class="controls">
					...
					<div class="input-icon left">
						...
						<input class="m-wrap placeholder-no-fix" type="password" placeholder="Password"
							   id="user_password_2"	   name="user_password"/>
			...
			<div class="form-actions">
				...
				<input type="button" class="btn blue pull-right" value="Login➤" onclick="LoginCheck2()">
